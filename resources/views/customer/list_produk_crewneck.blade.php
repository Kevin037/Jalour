@extends('main')
@section('judul')
<title>JALOUR | Produk Crewneck</title>
@endsection
@section('isi')
  ...
  <div class="sidebar-filter">
   FILTER
    <hr class="solid">
      ...
      <div class="slider">
        <div class="wrapper"><div class="filter-harga">Filter</div>
          <div class="values">
            Rp<span id="range1">
      ...
      <div class="row">
        ...
        <div class="col-6 col-md-4">
          ...
          <div class="part">
            ...
            <a href="/item_crewneck{{ $produk->id_produk }}" class="card teks" >{{ $produk->nama_produk }}</a>
