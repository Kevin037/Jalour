@extends('main')
@section('judul')
<title>JALOUR | Produk T-shirt</title>
@endsection
@section('isi')
 ...
 {{-- LIST PRODUK --}}
    <div class="col-lg-8" style="margin-bottom: 6%">
      ...
      <div class="row">
        ...
        <div class="col-6 col-lg-4  per-produk">
          ...
          <div class="part">
            ...
            <a href="/item_tshirt{{ $produk->id_produk }}" class="card teks" >{{ $produk->nama_produk }}</a>
            <div style="margin-top: 5px;display:flex;flex-direction:row">
              <div class="row">
                ...
                <div class="col-md-7 col-12">
                  <b><p style="margin-left:5px;color:rgb(20, 20, 20)">@currency_k($produk->harga_produk2)</p></b>
                </div> --}}
                <div class="col-3">
                  <p class="small" style="text-decoration: line-through rgb(173, 173, 173);color:rgb(173, 173, 173);font-style:italic;font-size:5px;"> @currency_k($produk->harga_produk1)</p>
                </div>
